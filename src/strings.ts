...
const languages = {
  de: {
    ...
    contactButtons: [
      {url: 'mailto:info@dwgradio.net', title: 'E-Mail'},
      {url: 'https://wa.me/4917640435016', title: 'WhatsApp'},
      {url: 'https://t.me/dwgradio_de_chat', title: 'Telegram'},
    ],
    additionalLinksButtons: [
      {url: 'http://load.dwgradio.net/de', title: 'DWG Load im Internet'},
      {url: 'http://radio.dwgradio.net/de', title: 'DWG Radio im Internet'},
      {url: 'https://t.me/dwgradiode', title: 'Telegram Kanal'},
    ],
  ...
  cz: {
    ...
    contactButtons: [{url: 'mailto:info.cz@dwgradio.net', title: 'e-mail'}],
    additionalLinksButtons: [
  ...
  ru: {
    ...
    contactButtons: [
      {url: 'mailto:info.ru@dwgradio.net', title: 'электронная почта'},
      {url: 'https://t.me/DWGradio_ru', title: 'Телеграмм'},
    ],
    additionalLinksButtons: [
      {url: 'http://load.dwgradio.net/ru', title: 'Ссылка на DWG Load'},
      {url: 'http://radio.dwgradio.net/ru', title: 'Ссылка на DWG Radio'},
      {url: 'https://t.me/dwgradiode', title: 'Телеграмм-канал'},
    ],
