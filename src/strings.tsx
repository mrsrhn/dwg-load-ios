...
const languages = {
  de: {
    ...
    yesterday: 'Gestern',
    info1:
      'DWG Load ist die Predigtdatenbank von DWG Radio. Gegenwärtig stehen über 12.000 Titel zum Hören, Speichern und Teilen bereit.',
    info2:
  ...
  ru: {
    ...
    sortOptionName: 'Популярность',
    sortOptionDuration: 'Длительность',
    sortOptionDate: 'Последние',
    sortOptionMostHeared: 'Популярные',
    sortOptionNew: 'Новое',
    sortOptionNameShort: 'Популярность',
    sortOptionDurationShort: 'Длительность',
    sortOptionDateShort: 'Последние',
    sortOptionMostHearedShort: 'Популярные',
    sortOptionNewShort: 'Новое',
    sortBy: 'Сортировать по',
    today: 'Сегодня',
    yesterday: 'Вчера',
    info1:
      'DWG Load — это база данных проповедей DWG Radio. В настоящее время доступно более 3000 проповедей, которые можно слушать, сохранять и делиться.',
    info2:
      'Все, без исключения, проповедники — верующие люди, последователи Иисуса Христа. Регулярно добавляются новые файлы',
    info3:
      'Ибо мы отчасти знаем и отчасти пророчествуем (1 Коринфянам 13:9), каждый проповедник представляет свои личные взгляды.',
    donation: '',
    donationInfo1:
      'DWG Radio e.V. финансируется исключительно за счет пожертвований. Мы будем рады, если вы поддержите DWG Radio своим пожертвованием.',
    donationInfo2: '',
